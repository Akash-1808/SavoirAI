...
// >
//   {/* Icon part (your current square/lines) */}
//   <path
//     d="M3 0H5V18H3V0ZM13 0H15V18H13V0ZM18 3V5H0V3H18ZM0 15V13H18V15H0Z"
//     fill={uniColor ? 'currentColor' : 'url(#logo-gradient)'}
//   />

//   {/* Replace path-based text with actual text */}
//   <text
//     x="25"
//     y="14"
...
export const Logo = ({ className }: { className?: string }) => {
  return (
    <div
      className={cn(
        "flex items-center gap-2 font-bold text-lg select-none group cursor-pointer",
        className
      )}
    >
      {/* Left Icon */}
      <svg
        ...
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        className="size-6 text-primary transition-colors duration-300 group-hover:text-[#2BC8B7]"
      >
        <path
          d="M3 0H5V18H3V0ZM13 0H15V18H13V0ZM18 3V5H0V3H18ZM0 15V13H18V15H0Z"
      ...
      {/* Brand Text */}
      <span
        className="bg-gradient-to-r from-[#9B99FE] to-[#2BC8B7] bg-clip-text text-transparent 
...
export const LogoStroke = ({ className }: { className?: string }) => {
  return (
    <svg
      className={cn("w-7 h-7 text-[#2BC8B7]", className)}
      viewBox="0 0 71 25"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
